...
public class RenderModelSprinterZombie extends ModelBiped {
    public RenderModelSprinterZombie() {
        this(0.0F, false);
    }

    public RenderModelSprinterZombie(float p_i1168_1_, boolean p_i1168_2_) {
