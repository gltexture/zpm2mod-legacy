...
public class RenderZombieCrouchedZp extends RenderBiped {
    private final ModelBiped field_82434_o;
    protected ModelBiped field_82437_k;
    protected ModelBiped field_82435_l;
    protected ModelBiped greenModel;

    public RenderZombieCrouchedZp() {
        super(new RenderModelSprinterZombie(), 0.5F, 1.0F);
        this.field_82434_o = this.modelBipedMain;
    }

    protected void func_82421_b() {
        this.modelArmourChestplate = new RenderModelSprinterZombie(1.0F, true);
        this.field_82425_h = new RenderModelSprinterZombie(0.5F, true);
        this.greenModel = new RenderModelSprinterZombie(0.15F, false);
