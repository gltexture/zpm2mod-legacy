...
public class RenderZombieStrongZp extends RenderBiped {
    private final ModelBiped field_82434_o;
    protected ModelBiped field_82437_k;
    protected ModelBiped field_82435_l;
    protected ModelBiped greenModel;

    public RenderZombieStrongZp() {
        super(new RenderModelStrongZombie(), 0.5F, 1.0F);
        this.field_82434_o = this.modelBipedMain;
    }

    protected void func_82421_b() {
        this.modelArmourChestplate = new RenderModelStrongZombie(1.0F, true);
        this.field_82425_h = new RenderModelStrongZombie(0.5F, true);
        this.greenModel = new RenderModelStrongZombie(0.15F, false);
