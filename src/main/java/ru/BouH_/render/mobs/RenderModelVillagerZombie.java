...
public class RenderModelVillagerZombie extends ModelBiped {
    public RenderModelVillagerZombie() {
        this(0.0F, 0.0F, false);
    }

    public RenderModelVillagerZombie(float p_i1165_1_, float p_i1165_2_, boolean p_i1165_3_) {
