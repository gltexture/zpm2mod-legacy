...
public class RenderFlareProjectile extends Render {
    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/flare.png");
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderFlareProjectile.resourceLocation;
    }
}
