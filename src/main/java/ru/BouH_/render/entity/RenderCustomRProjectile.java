...
public class RenderCustomRProjectile extends Render {
    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/rocketCustom.png");

    public RenderCustomRProjectile() {
    }
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderCustomRProjectile.resourceLocation;
    }
}
