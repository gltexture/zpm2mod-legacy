...
public class BlockStakes extends Block implements ITileEntityProvider {
    ...
    public BlockStakes(boolean isDamaged) {
        ...
        if (!worldIn.isRemote) {
            if (entityIn instanceof EntityLivingBase) {
                if (this.blockHardness >= 0) {
                    ...
                    if (tileBlockWithDamage.getDamage() >= this.blockHardness * 116.0f) {
                        if (this.isDamaged) {
                            worldIn.breakBlock(p_149670_2_, p_149670_3_, p_149670_4_, false);
                        } else {
                            worldIn.setBlock(p_149670_2_, p_149670_3_, p_149670_4_, BlocksZp.wooden_stakes_stage2);
                        }
                ...
                entityIn.attackEntityFrom(DamageSourceZp.stakes, 1);
