...
public class ItemFreezer extends Item {
    public ItemFreezer(String unlocalizedName) {
        ...
        if (!p_77648_2_.worldObj.isRemote) {
            ...
            if (tileEntity != null) {
                if (tileEntity instanceof TileLootCase) {
                    ...
                    tileLootCase.freezeChest();
                    ChatComponentTranslation chatComponentTranslation = new ChatComponentTranslation("tools.freezer.success");
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List tooltip, boolean advanced) {
        tooltip.add(EnumChatFormatting.AQUA + I18n.format("tools.freezer"));
    }
}
