...
public class ItemM203 extends ALauncherModuleBase {
    public ItemM203(String name, String shootSound, String reloadSound, int shootCd, int reloadCd, AAmmo aAmmo, int maxAmmo) {
    ...
    public void shoot(AGunBase aGunBase, ItemStack stack, EntityPlayer player, float rotationPitch, float rotationYaw, boolean scoping) {
        ...
        if (!player.worldObj.isRemote) {
            ...
            EntityGrenade40 grenade = new EntityGrenade40(player.worldObj, player, 2.0f, inaccuracy);
