...
public class ProjectileKalibrRocket extends BehaviorProjectileDispense {

    protected IProjectile getProjectileEntity(World par1World, IPosition par2IPosition) {
        return new EntityKalibrRocket(par1World, par2IPosition.getX(), par2IPosition.getY(), par2IPosition.getZ());
    }
    ...
    public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
        ...
        iprojectile.setThrowableHeading(enumfacing.getFrontOffsetX(), (float) enumfacing.getFrontOffsetY() + 2.8F, enumfacing.getFrontOffsetZ(), 3.5f, 3.0f);
