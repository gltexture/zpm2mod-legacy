...
public class ProjectileR27Rocket extends BehaviorProjectileDispense {

    protected IProjectile getProjectileEntity(World par1World, IPosition par2IPosition) {
        return new EntityR27Rocket(par1World, par2IPosition.getX(), par2IPosition.getY(), par2IPosition.getZ());
    }
    ...
    public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
        ...
        iprojectile.setThrowableHeading(enumfacing.getFrontOffsetX(), (float) enumfacing.getFrontOffsetY() + 0.5F, enumfacing.getFrontOffsetZ(), 2.2f, 3.0f);
