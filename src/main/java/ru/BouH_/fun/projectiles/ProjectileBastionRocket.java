...
public class ProjectileBastionRocket extends BehaviorProjectileDispense {

    protected IProjectile getProjectileEntity(World par1World, IPosition par2IPosition) {
        return new EntityBastionRocket(par1World, par2IPosition.getX(), par2IPosition.getY(), par2IPosition.getZ());
    }
    ...
    public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
        ...
        iprojectile.setThrowableHeading(enumfacing.getFrontOffsetX(), (float) enumfacing.getFrontOffsetY() + 1.25F, enumfacing.getFrontOffsetZ(), 2.8f, 4.0f);
