...
public class ProjectileSolncepekRocket extends BehaviorProjectileDispense {

    protected IProjectile getProjectileEntity(World par1World, IPosition par2IPosition) {
        return new EntitySolncepekRocket(par1World, par2IPosition.getX(), par2IPosition.getY(), par2IPosition.getZ());
    }
    ...
    public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
        ...
        iprojectile.setThrowableHeading(enumfacing.getFrontOffsetX() + (Main.rand.nextFloat() - Main.rand.nextFloat()) * 0.4f, (float) enumfacing.getFrontOffsetY() + 0.2f + Main.rand.nextFloat() * 0.1f, enumfacing.getFrontOffsetZ() + (Main.rand.nextFloat() - Main.rand.nextFloat()) * 0.4f, 1.8f, 0.0f);
