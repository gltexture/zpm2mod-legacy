...
public class ProjectileGradRocket extends BehaviorProjectileDispense {

    protected IProjectile getProjectileEntity(World par1World, IPosition par2IPosition) {
        return new EntityGradRocket(par1World, par2IPosition.getX(), par2IPosition.getY(), par2IPosition.getZ());
    }
    ...
    public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
        ...
        iprojectile.setThrowableHeading(enumfacing.getFrontOffsetX() + (Main.rand.nextFloat() - Main.rand.nextFloat()) * 0.5f, (float) enumfacing.getFrontOffsetY() + 0.1f + Main.rand.nextFloat() * 0.1f, enumfacing.getFrontOffsetZ() + (Main.rand.nextFloat() - Main.rand.nextFloat()) * 0.5f, 2.2f, 0.0f);
