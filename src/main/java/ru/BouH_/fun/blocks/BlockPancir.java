...
public class BlockPancir extends BlockStone implements ITileEntityProvider {
    ...
    public void registerIcons(IIconRegister p_149651_1_) {
        this.field_149986_M = p_149651_1_.registerIcon(Main.MODID + ":pancir_0");
        this.field_149984_b = p_149651_1_.registerIcon(Main.MODID + ":pancir_1");
    }
