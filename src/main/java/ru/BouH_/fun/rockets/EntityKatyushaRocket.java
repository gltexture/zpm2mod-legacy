...
public class EntityKatyushaRocket extends EntityDetectableRocketZp {

    public EntityKatyushaRocket(World p_i1776_1_) {
        super(p_i1776_1_);
    }

    public EntityKatyushaRocket(World p_i1778_1_, double p_i1778_2_, double p_i1778_4_, double p_i1778_6_) {
        super(p_i1778_1_, p_i1778_2_, p_i1778_4_, p_i1778_6_);
    }

    public void explode() {
        ExplosionUtils.makeExplosion(this.worldObj, null, this, this.posX, this.posY + (double) (this.height / 16.0F), this.posZ, 3.0f, true, true, false);
        this.setDead();
    }
