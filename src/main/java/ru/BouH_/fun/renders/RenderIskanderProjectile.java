...
public class RenderIskanderProjectile extends Render {

    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/rocketIskander.png");
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderIskanderProjectile.resourceLocation;
    }
}
