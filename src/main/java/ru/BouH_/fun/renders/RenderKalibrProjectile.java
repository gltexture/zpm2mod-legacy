...
public class RenderKalibrProjectile extends Render {

    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/rocketKalibr.png");
    ...
    private void renderEntity(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_9_) {
        ...
        tessellator.addVertexWithUV(-1.0D, 6.0D, 0.0D, 0.0f, (float) (26) / 32.0F);
        tessellator.addVertexWithUV(1.0D, 6.0D, 0.0D, (float) (2) / 32.0F, (float) (26) / 32.0F);
        tessellator.addVertexWithUV(1.0D, -6.0D, 0.0D, (float) (2) / 32.0F, (float) (22) / 32.0F);
        tessellator.addVertexWithUV(-1.0D, -6.0D, 0.0D, 0.0f, (float) (22) / 32.0F);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.addVertexWithUV(-1.0D, -6.0D, 0.0D, 0.0f, (float) (26) / 32.0F);
        tessellator.addVertexWithUV(1.0D, -6.0D, 0.0D, (float) (2) / 32.0F, (float) (26) / 32.0F);
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderKalibrProjectile.resourceLocation;
    }
}
