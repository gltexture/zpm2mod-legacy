...
public class RenderSolncepekProjectile extends Render {
    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/rocketSolncepek.png");

    public RenderSolncepekProjectile() {
    }
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderSolncepekProjectile.resourceLocation;
    }
}
