...
public class RenderIglaProjectile extends Render {
    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/rocketIgla.png");

    public RenderIglaProjectile() {
    }
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderIglaProjectile.resourceLocation;
    }
}
