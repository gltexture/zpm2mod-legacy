...
public class RenderBastionProjectile extends Render {

    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/rocketBastion.png");
    ...
    private void renderEntity(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_9_) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            tessellator.addVertexWithUV(-2.0D, -3.5D, 0.0D, f6, f8);
            tessellator.addVertexWithUV(2.0D, -3.5D, 0.0D, f7, f8);
            tessellator.addVertexWithUV(2.0D, 3.5D, 0.0D, f7, f9);
            tessellator.addVertexWithUV(-2.0D, 3.5D, 0.0D, f6, f9);
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.addVertexWithUV(-2.0D, 3.5D, 0.0D, f6, f8);
            tessellator.addVertexWithUV(2.0D, 3.5D, 0.0D, f7, f8);
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderBastionProjectile.resourceLocation;
    }
}
