...
public class RenderOvodProjectile extends Render {

    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/rocketOvod.png");
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderOvodProjectile.resourceLocation;
    }
}
