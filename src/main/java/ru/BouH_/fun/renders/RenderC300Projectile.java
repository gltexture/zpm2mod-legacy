...
public class RenderC300Projectile extends Render {
    ...
    private void renderEntity(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_9_) {
        ...
        tessellator.addVertexWithUV(-2.0D, 6.0D, 0.0D, 0.0f, (float) (22) / 32.0F);
        tessellator.addVertexWithUV(2.0D, 6.0D, 0.0D, (float) (22) / 32.0F, (float) (22) / 32.0F);
        tessellator.addVertexWithUV(2.0D, -6.0D, 0.0D, (float) (22) / 32.0F, (float) (22) / 32.0F);
        tessellator.addVertexWithUV(-2.0D, -6.0D, 0.0D, 0.0f, (float) (26) / 32.0F);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.addVertexWithUV(-2.0D, -6.0D, 0.0D, 0.0f, (float) (22) / 32.0F);
        tessellator.addVertexWithUV(2.0D, -6.0D, 0.0D, (float) (22) / 32.0F, (float) (22) / 32.0F);
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderC300Projectile.resourceLocation;
    }
}
