...
public class RenderPancirProjectile extends Render {

    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/rocketR27.png");
    ...
    private void renderEntity(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_9_) {
        ...
        tessellator.addVertexWithUV(-4.0D, -4.0D, 0.0D, f6, f8);
        tessellator.addVertexWithUV(4.0D, -4.0D, 0.0D, f7, f8);
        tessellator.addVertexWithUV(4.0D, 4.0D, 0.0D, f7, f9);
        tessellator.addVertexWithUV(-4.0D, 4.0D, 0.0D, f6, f9);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.addVertexWithUV(-4.0D, 4.0D, 0.0D, f6, f8);
        tessellator.addVertexWithUV(4.0D, 4.0D, 0.0D, f7, f8);
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderPancirProjectile.resourceLocation;
    }
}
