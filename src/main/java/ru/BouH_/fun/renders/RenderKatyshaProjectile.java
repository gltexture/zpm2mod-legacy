...
public class RenderKatyshaProjectile extends Render {
    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/rocketKatyusha.png");

    public RenderKatyshaProjectile() {
    }
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderKatyshaProjectile.resourceLocation;
    }
}
