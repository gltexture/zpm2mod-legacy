...
public class RenderKinzhalProjectile extends Render {

    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MODID + ":textures/entity/rocketKinzhal.png");
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return RenderKinzhalProjectile.resourceLocation;
    }
}
