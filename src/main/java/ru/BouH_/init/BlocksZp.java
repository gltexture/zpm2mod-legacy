...
public class BlocksZp {
    ...
    public static void init() {
        ...
        furnace_destroyed.setCreativeTab(ItemsZp.decorations);
        ...
        empty_bookshelf.setCreativeTab(ItemsZp.decorations);
        ...
        debrisand.setCreativeTab(ItemsZp.blocks);
        ...
        frozen_dirt.setCreativeTab(ItemsZp.blocks);
        ...
        sand_layer.setCreativeTab(ItemsZp.decorations);
        ...
        wooden_stakes_stage2.setCreativeTab(ItemsZp.blocks);
        ...
        wire.setCreativeTab(ItemsZp.blocks);
        ...
        wire_stage2.setCreativeTab(ItemsZp.blocks);
        ...
        wire_reinforced.setCreativeTab(ItemsZp.blocks);
        ...
        wire3.setCreativeTab(ItemsZp.blocks);
        ...
        uranium.setCreativeTab(ItemsZp.blocks);
        ...
        armor.setCreativeTab(ItemsZp.blocks);
        ...
        armor2.setCreativeTab(ItemsZp.blocks);
        ...
        concreteStairs.setCreativeTab(ItemsZp.blocks);
        ...
        concrete3.setCreativeTab(ItemsZp.blocks);
        ...
        concrete_green.setCreativeTab(ItemsZp.blocks);
        ...
        sandbag.setCreativeTab(ItemsZp.blocks);
        ...
        concrete_f.setCreativeTab(ItemsZp.blocks);
        ...
        concrete_f2.setCreativeTab(ItemsZp.blocks);
        ...
        lab.setCreativeTab(ItemsZp.blocks);
        ...
        lamp_off.setCreativeTab(ItemsZp.decorations);
        ...
        block_lamp.setCreativeTab(ItemsZp.decorations);
        ...
        block_lamp_off.setCreativeTab(ItemsZp.decorations);
        ...
        c300Block.setCreativeTab(ItemsZp.fun);
        ...
        pancirBlock.setCreativeTab(ItemsZp.fun);
        ...
        kalibrBlock.setCreativeTab(ItemsZp.fun);
