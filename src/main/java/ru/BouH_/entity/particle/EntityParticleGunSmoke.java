...
public class EntityParticleGunSmoke extends EntityFX {

    public EntityParticleGunSmoke(World p_i1205_1_, double p_i1205_2_, double p_i1205_4_, double p_i1205_6_, double p_i1205_8_, double p_i1205_10_, double p_i1205_12_) {
        super(p_i1205_1_, p_i1205_2_, p_i1205_4_, p_i1205_6_, p_i1205_8_, p_i1205_10_, p_i1205_12_);
        this.motionX = p_i1205_8_ + (double) ((float) (Math.random() * 2.0D - 1.0D) * 0.125F);
        this.motionY = p_i1205_10_ + (double) ((float) (Math.random() * 2.0D - 1.0D) * 0.125F);
        this.motionZ = p_i1205_12_ + (double) ((float) (Math.random() * 2.0D - 1.0D) * 0.125F);
        //this.setSize(0.1F, 1.4F);

        float cl = Main.rand.nextFloat() * 0.4f + 0.3f;
        this.particleRed = cl;
        this.particleGreen = cl;
        this.particleBlue = cl;
        this.particleScale = Main.rand.nextFloat() * 2.0f + 0.5f;
