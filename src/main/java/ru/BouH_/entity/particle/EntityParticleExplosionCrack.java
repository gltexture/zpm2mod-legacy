...
public class EntityParticleExplosionCrack extends EntityDiggingFX {
    private final Block field_145784_a;

    public EntityParticleExplosionCrack(World p_i1234_1_, double p_i1234_2_, double p_i1234_4_, double p_i1234_6_, double p_i1234_8_, double p_i1234_10_, double p_i1234_12_, Block p_i1234_14_, int p_i1234_15_, float scale) {
        super(p_i1234_1_, p_i1234_2_, p_i1234_4_, p_i1234_6_, p_i1234_8_, p_i1234_10_, p_i1234_12_, p_i1234_14_, p_i1234_15_);
        this.motionX = p_i1234_8_ + (double) ((float) (Math.random() * 2.0D - 1.0D) * 0.15F);
        this.motionY = p_i1234_10_ + (double) ((float) (Math.random() * 2.0D - 1.0D) * 0.15F);
        this.motionZ = p_i1234_12_ + (double) ((float) (Math.random() * 2.0D - 1.0D) * 0.15F);
        this.field_145784_a = p_i1234_14_;
        this.setParticleIcon(p_i1234_14_.getIcon(0, p_i1234_15_));
        this.particleGravity = 0.8f;
        this.particleRed = this.particleGreen = this.particleBlue = 0.8F;
        this.particleScale = scale + Main.rand.nextFloat() * 0.1f;
        this.particleMaxAge = rand.nextInt(21) + 40;
    }

    public EntityParticleExplosionCrack applyColourMultiplier(int p_70596_1_, int p_70596_2_, int p_70596_3_) {
    ...
    public EntityParticleExplosionCrack applyRenderColor(int p_90019_1_) {
