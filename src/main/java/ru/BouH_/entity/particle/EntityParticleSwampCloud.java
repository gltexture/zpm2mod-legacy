...
public class EntityParticleSwampCloud extends EntityFX {
    public EntityParticleSwampCloud(World p_i1205_1_, double p_i1205_2_, double p_i1205_4_, double p_i1205_6_) {
        super(p_i1205_1_, p_i1205_2_, p_i1205_4_, p_i1205_6_, 0.0f, 0.0f, 0.0f);
        this.motionX = (Main.rand.nextFloat() - Main.rand.nextFloat()) * 0.05f;
        this.motionY = -0.05f;
        this.motionZ = (Main.rand.nextFloat() - Main.rand.nextFloat()) * 0.05f;
