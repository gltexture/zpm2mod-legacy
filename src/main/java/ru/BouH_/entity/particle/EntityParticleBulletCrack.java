...
public class EntityParticleBulletCrack extends EntityDiggingFX {
    private final Block field_145784_a;
    private final int side;

    public EntityParticleBulletCrack(World p_i1234_1_, double p_i1234_2_, double p_i1234_4_, double p_i1234_6_, double p_i1234_8_, double p_i1234_10_, double p_i1234_12_, Block p_i1234_14_, int p_i1234_15_) {
    ...
    public EntityParticleBulletCrack(World p_i1234_1_, double p_i1234_2_, double p_i1234_4_, double p_i1234_6_, double p_i1234_8_, double p_i1234_10_, double p_i1234_12_, Block p_i1234_14_, int p_i1234_15_, int side) {
        ...
        this.particleScale = 0.6f + Main.rand.nextFloat() * 0.1f;
        this.particleMaxAge = rand.nextInt(21) + 10;
        this.side = side;
    }

    public EntityParticleBulletCrack applyColourMultiplier(int p_70596_1_, int p_70596_2_, int p_70596_3_) {
    ...
    public EntityParticleBulletCrack applyRenderColor(int p_90019_1_) {
