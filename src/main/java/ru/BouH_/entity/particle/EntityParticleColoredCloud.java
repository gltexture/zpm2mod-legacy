...
public class EntityParticleColoredCloud extends EntityFX {
    public EntityParticleColoredCloud(World p_i1205_1_, double p_i1205_2_, double p_i1205_4_, double p_i1205_6_, double p_i1205_8_, double p_i1205_10_, double p_i1205_12_, float[] cl, float scale) {
        super(p_i1205_1_, p_i1205_2_, p_i1205_4_, p_i1205_6_, p_i1205_8_, p_i1205_10_, p_i1205_12_);
        this.motionX = p_i1205_8_ + (double) ((float) (Math.random() * 2.0D - 1.0D) * 0.1F);
        this.motionY = p_i1205_10_ + (double) ((float) (Math.random() * 2.0D - 1.0D) * 0.1F);
        this.motionZ = p_i1205_12_ + (double) ((float) (Math.random() * 2.0D - 1.0D) * 0.1F);

        float rand = (float) (Math.random() * 0.3f);
        this.particleRed = cl[0] - rand;
        this.particleGreen = cl[1] - rand;
        this.particleBlue = cl[2] - rand;

        this.particleScale = (float) ((Math.random() * 0.5 + 3)) * scale;
        this.particleMaxAge = this.rand.nextInt(51) + 100;
    }
