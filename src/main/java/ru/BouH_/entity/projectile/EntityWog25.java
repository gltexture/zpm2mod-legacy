...
public class EntityWog25 extends EntityThrowableZPBase {
    ...
    public EntityWog25(World p_i1776_1_) {
        super(p_i1776_1_);
    }

    public EntityWog25(World p_i1778_1_, double p_i1778_2_, double p_i1778_4_, double p_i1778_6_) {
        super(p_i1778_1_, p_i1778_2_, p_i1778_4_, p_i1778_6_);
    }

    public EntityWog25(World p_i1756_1_, EntityLivingBase p_i1756_2_, float speed, float p_i1756_3_) {
