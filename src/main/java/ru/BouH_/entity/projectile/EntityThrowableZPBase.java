...
public abstract class EntityThrowableZPBase extends Entity implements IProjectile {
    public int throwableShake;
    protected boolean inGround;
    protected int field_145788_c = -1;
    protected int field_145786_d = -1;
    protected int field_145787_e = -1;
    protected Block field_145785_f;
    protected EntityLivingBase thrower;
    protected String throwerName;
    protected int ticksInGround;
    protected int ticksInAir;

    public EntityThrowableZPBase(World p_i1776_1_) {
        super(p_i1776_1_);
        this.setSize(0.2F, 0.2F);
    }

    public EntityThrowableZPBase(World p_i1777_1_, EntityLivingBase p_i1777_2_, float speed, float inac) {
        super(p_i1777_1_);
    ...
    public EntityThrowableZPBase(World p_i1778_1_, double p_i1778_2_, double p_i1778_4_, double p_i1778_6_) {
        super(p_i1778_1_);
