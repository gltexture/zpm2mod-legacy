...
public class EntityZombieHalloween extends AZombieBase {
    @SuppressWarnings("unchecked")
    public EntityZombieHalloween(World p_i1745_1_) {
        super(p_i1745_1_);
    ...
    public boolean getCanSpawnHere() {
        return super.getCanSpawnHere() && Main.isHalloween();
    }

    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
        this.dropItem(ItemsZp.bag, 1);
    }
    ...
    protected void addRandomArmor() {
        if (Main.rand.nextFloat() <= 0.1f) {
            ...
            this.setCurrentItemOrArmor(0, new ItemStack(ItemsZp.scare_sword));
        }
    }
