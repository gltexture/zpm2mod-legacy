...
public class RenderSandStorm {
    public static final ResourceLocation locationStormPng = new ResourceLocation(Main.MODID + ":textures/misc/sand_storm.png");
    public static final ResourceLocation locationWeakStormPng = new ResourceLocation(Main.MODID + ":textures/misc/weak_sand_storm.png");
    public static final ResourceLocation locationStrongStormPng = new ResourceLocation(Main.MODID + ":textures/misc/strong_sand_storm.png");
                    ...
                    if (biomegenbase == BiomeGenBase.desert || biomegenbase == BiomeGenBase.desertHills) {
                        ...
                        if (l1 != i2) {
                            ...
                            if (b1 != 0) {
                                b1 = 0;
                                if (f1 <= 0.3f) {
                                    entityRenderer.mc.getTextureManager().bindTexture(RenderSandStorm.locationWeakStormPng);
                                } else if (f1 <= 0.5f) {
                                    entityRenderer.mc.getTextureManager().bindTexture(RenderSandStorm.locationStormPng);
                                } else {
                                    entityRenderer.mc.getTextureManager().bindTexture(RenderSandStorm.locationStrongStormPng);
                                }
                                tessellator.startDrawingQuads();
                            }

                            f10 = ((float) (entityRenderer.rendererUpdateCount + i1 * i1 * 3121 + i1 * 45238971 + l * l * 418711 + l * 13761 & 31) + p_78474_1_) / 28.0F * (3.0F + entityRenderer.random.nextFloat());
                            float f11 = ((float) (entityRenderer.rendererUpdateCount + i1 * i1 * 3121 + i1 * 45238971 + l * l * 418711 + l * 13761 & 31) + p_78474_1_) / 256.0F * (2.0F + entityRenderer.random.nextFloat());
                            ...
                            tessellator.addVertexWithUV((double) ((float) i1 - f6) + 0.5D, l1, (double) ((float) l - f7) + 0.5D, 0.0F * f8 + f10, (float) l1 * f8 / 4.0F * f8 + f11);
                            tessellator.addVertexWithUV((double) ((float) i1 + f6) + 0.5D, l1, (double) ((float) l + f7) + 0.5D, f8 + f10, (float) l1 * f8 / 4.0F * f8 + f11);
                            tessellator.addVertexWithUV((double) ((float) i1 + f6) + 0.5D, i2, (double) ((float) l + f7) + 0.5D, f8 + f10, (float) i2 * f8 / 4.0F * f8 + f11);
                            tessellator.addVertexWithUV((double) ((float) i1 - f6) + 0.5D, i2, (double) ((float) l - f7) + 0.5D, 0.0F * f8 + f10, (float) i2 * f8 / 4.0F * f8 + f11);
    ...
    public void addStormParticles(EntityRenderer entityRenderer) {
        ...
        if (f != 0.0F) {
            ...
            for (int j1 = 0; j1 < i1; ++j1) {
                ...
                if (i2 <= j + b0 && i2 >= j - b0 && biomegenbase == BiomeGenBase.desert || biomegenbase == BiomeGenBase.desertHills) {
                    ...
                    if (block.getMaterial() != Material.air && !block.getMaterial().isLiquid()) {
                        ...
                        entityRenderer.mc.effectRenderer.addEffect(new EntityParticleSand(worldclient, (float) k1 + f1, (double) ((float) i2 + 0.1F) - block.getBlockBoundsMinY(), (float) l1 + f2));
                    }
                }
            }
        }
